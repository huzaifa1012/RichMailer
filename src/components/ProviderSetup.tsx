...
const AppPasswordGuide = () => {
  ...
  const steps = [
    ...
    { step: "2", text: 'Navigate to Security → 2-Step Verification (must be enabled first)' },
    { step: "3", text: 'Scroll to the bottom and click on "App passwords"' },
    { step: "4", text: 'Select app type as "Mail" and your device' },
    { step: "5", text: "Click Generate — Google will show a 16-character password" },
    { step: "6", text: "Copy and paste that password here (spaces are optional)" },
  ];
